...
def main():
    ...
    parser.add_argument('--result_folder', default='cropped_training_images', help='Path for cropped images')
    parser.add_argument('--bbox_path', default='/content/GP-GAN/DataBase/DentraTrainingData/bbox.txt',
